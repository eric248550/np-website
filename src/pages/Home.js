        ...
        <div className="flex flex-col bg-[#292929]">
            ...
            <div className='mt-10 w-5/6 m-auto flex flex-col md:flex-row justify-center'>
                ...
                <div className='m-auto mt-5 md:w-2/3 md:ml-10 flex flex-col'>
                    ...
                    <p className='mt-5 text-white text-lg font-[SemplicitaPro]'>Stay on the loop of the usability of this technology.</p>
                    <div className='mt-5 flex flex-row justify-center'>
                        <input type="text" className='bg-[#292929] w-2/5 h-10 border-[1px] border-r-0 border-[868686] text-base md:text-sm text-center'
            ...
            <div className='mt-20 w-5/6 m-auto flex flex-col md:flex-row justify-center'>
                ...
                <img className='hidden md:inline ml-10 m-auto w-1/3' src={trangleArrow}/>
